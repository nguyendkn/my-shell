...
// FPT Smart Cloud branding: thay creature ASCII của Claude bằng silhouette
// "cloud" — silent, geometric, colored theo `clawd_body`/`clawd_background`
// (đã remap sang FPT blue/navy trong `fpt` theme). Các pose animation giữ
// để không break render, nhưng tất cả biến về cùng 1 shape — CLI không cần
// "blink/wave" nữa.
// FPT Smart Cloud branded unicorn silhouette (kỳ lân một sừng):
//   row 1 = horn tip centered (▀)
//   row 2 = head with ears (▗▙ ... ▟▖)
//   row 3 = 4 hooves pattern (▘▘ ▝▝) — giữ từ design gốc
// Tất cả poses 9 cells (r1L 2 + r1E 5 + r1R 2) để căn giữa dưới
// `alignItems="center"`. Các pose animation convert cùng shape — không
// blink/look/wave để giữ silhouette tĩnh, enterprise.
