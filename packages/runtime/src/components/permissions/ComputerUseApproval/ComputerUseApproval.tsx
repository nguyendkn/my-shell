  ...
  if ($[21] !== checked || $[22] !== request.apps) {
    ...
    if ($[24] !== checked) {
      t14 = (a_3) => {
        ...
        // The shim implementation of getSentinelCategory currently accepts no
        // arguments; reference resolved.bundleId here so the lookup intent is
        // preserved for callers (and future shim revisions).
        void resolved.bundleId;
