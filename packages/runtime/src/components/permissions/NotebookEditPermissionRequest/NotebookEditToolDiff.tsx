...
// Mirrors NotebookCell["cell_type"]; declared locally because the source type
// in src/types/notebook.ts does not yet re-export this alias.
type NotebookCellType = NotebookCell["cell_type"];
