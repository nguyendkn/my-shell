...
type BootstrapBoundaryProps = { children: React.ReactNode };

class BootstrapBoundary extends React.Component<BootstrapBoundaryProps, BootstrapBoundaryState> {
  declare props: BootstrapBoundaryProps;
  state: BootstrapBoundaryState = {
    error: null,
  };
  static getDerivedStateFromError(error: Error): BootstrapBoundaryState {
    return {
      error,
    };
  }
