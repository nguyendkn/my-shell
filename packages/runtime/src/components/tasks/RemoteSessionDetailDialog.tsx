...
type Props = {
  ...
  onBack?: () => void;
  onKill?: () => void;
  // React's special `key` prop. Without @types/react in this workspace,
  // strict destructured Props don't pick it up automatically — declare so
  // callers can pass `<RemoteSessionDetailDialog key=... />`.
  key?: string;
};
