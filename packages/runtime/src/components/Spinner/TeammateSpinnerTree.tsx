...
export function TeammateSpinnerTree(t0: Props) {
  ...
  if (
    ...
    bb0: {
      ...
      // Two different InProcessTeammateTaskState types end up reachable
      // from this site (different module copies of the same shape); cast
      // the whole component through `unknown` so TS stops trying to
      // align the two structurally-identical-but-nominally-distinct props.
      const Line = TeammateSpinnerLine as unknown as (props: unknown) => React.ReactNode;
