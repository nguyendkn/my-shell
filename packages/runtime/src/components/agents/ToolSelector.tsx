...
export function ToolSelector(t0) {
  ...
  // The React-compiler-generated cache slot ($[21]) erases this binding's
  // type to `unknown` on the cache-hit branch; pin it to the bucket shape
  // so downstream selectors keep their typed `tool.name` access.
  let buckets: {
    readOnly: Tool[];
    edit: Tool[];
    execution: Tool[];
