...
export function MemoryStep() {
  ...
  if (
    ...
    t2 = (value) => {
      ...
      updateWizardData({
        // selectedMemory is typed as SettingSource on AgentWizardData (the
        // shape consumed by the agent-write paths); the wizard step picks
        // an AgentMemoryScope alias here, so cast at the seam.
        selectedMemory: memory as Parameters<typeof updateWizardData>[0]["selectedMemory"],
