 ...
 */
// Flattened (vs. discriminated on `done`) because the runtime tsconfig
// has strict:false; callers check `done` before reading branch fields.
type RetryResult<T> = { done: boolean; value?: T; error?: string };
