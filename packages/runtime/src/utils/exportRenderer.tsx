...
function normalizedUpperBound(m: Message): number {
  ...
  // m.message widens to `string | inner-message-shape`; only the latter
  // carries a content array, and only blocks-arrays expand 1:N.
  const inner = m.message;
  if (typeof inner === "string") return 1;
