  ...
  if (output.image) {
    outputs.push({
      ...
      source: {
        ...
        // media_type comes from the notebook kernel and is widened to string
        // at NotebookOutputImage; the SDK enumerates the supported MIMEs.
        // Cast at the boundary — the value is constrained to image/* by the
        // extractImage filter upstream.
        media_type: output.image.media_type as
          | "image/png"
          | "image/jpeg"
          | "image/gif"
          | "image/webp",
