...
export function buildSessionContext(): ComputerUseSessionContext {
  return {
    ...
    getAllowedApps: () =>
      // computerUseMcpState.allowedApps is readonly; the consumer signature
      // wants a mutable shape with optional fields. Spread to a fresh
      // mutable copy to satisfy both.
      [...(tuc().getAppState().computerUseMcpState?.allowedApps ?? [])] as Array<{
        bundleId?: string;
        displayName?: string;
      }>,
