...
// strictNullChecks) — discriminated unions on `success` don't narrow
// optional fields off the unselected branch. Callers must check `success`
// before reading branch-specific fields.
