  ...
  async function onSelect(log_0: LogOption) {
    ...
    if (crossProjectCheck.isCrossProject) {
      if (crossProjectCheck.isSameRepoWorktree === false) {
        const { command } = crossProjectCheck;
    ...
    try {
      ...
      if (feature("CONTEXT_COLLAPSE")) {
        // restoreFromEntries currently has no arguments in the stub implementation;
        // the commits/snapshot are still computed eagerly to preserve any side
        // effects from accessing those properties (e.g., lazy getters).
        void result_3.contextCollapseCommits;
        void result_3.contextCollapseSnapshot;
        /* eslint-disable @typescript-eslint/no-require-imports */
        (
