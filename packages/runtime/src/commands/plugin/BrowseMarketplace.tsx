...
export function BrowseMarketplace({
        ...
        for (const { name, config: marketplaceConfig, data: marketplace } of marketplaces_0) {
          if (marketplace) {
            ...
            const installedFromThisMarketplace = count(
              marketplace.plugins as ReadonlyArray<{ name: string }>,
    ...
    for (const plugin_1 of pluginsToInstall) {
      ...
      if (result.success === true) {
        ...
        newFailedPlugins.push({
          ...
          reason: "error" in result ? result.error : "unknown error",
        });
      }
    }
  ...
  const handleSinglePluginInstall = async (
    ...
    if (result_0.success === true) {
      ...
      setIsInstalling(false);
      setInstallError("error" in result_0 ? result_0.error : "unknown error");
    }
  };
