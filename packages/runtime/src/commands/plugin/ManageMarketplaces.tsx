...
export function ManageMarketplaces({
  ...
  const getPendingCounts = () => {
    const updateCount = count(marketplaceStates, (s: MarketplaceState) => s.pendingUpdate);
    const removeCount = count(marketplaceStates, (s: MarketplaceState) => s.pendingRemove);
    return {
      updateCount,
      removeCount,
    };
