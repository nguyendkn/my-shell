// Inlined từ `packages/runtime/vendor/modifiers-napi-src/index.ts` để shim
// self-contained — relative `../../vendor/...` và workspace alias `@repo/...`
// đều không resolve được khi shim được install như `file:` dep (bun copy
// thành `node_modules/.bun/modifiers-napi@.../node_modules/modifiers-napi/`
// không kèm vendor/ hoặc @repo/).
