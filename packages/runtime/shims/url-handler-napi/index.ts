// Inlined from packages/runtime/vendor/url-handler-src/index.ts so the bun
// hoisted cache at node_modules/.bun/url-handler-napi@.../... can type-check
// without a relative path that only resolves from the source location.
