---
description: "Handles schema design, query quality, and database operations."
mode: subagent
---
...
<!-- model: gemini-3-pro-preview | upgrade: claude-opus-4-6-thinking (critical optimization) -->
