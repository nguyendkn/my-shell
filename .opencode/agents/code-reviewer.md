---
description: "Reviews code for bugs, regressions, security risks, and missing work."
mode: subagent
---
...
<!-- model: gemini-claude-sonnet-4-5-thinking | upgrade: claude-opus-4-6-thinking (security audit) -->
...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `./docs/opencode/development-rules.md` and `./docs/code-standards.md`
...
1. **Initial Analysis**:
   ...
   - You can use `/vk:scout:ext` (preferred) or `/vk:scout` (fallback) command to search the codebase for files needed to complete the task
...
- Respect project-specific standards defined in `./docs/opencode/development-rules.md` and `./docs/code-standards.md`
