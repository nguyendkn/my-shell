---
description: "Debates solution options, tradeoffs, and product direction before implementation."
mode: subagent
---
...
model: sonnet
description: >-
  Use this agent when you need to brainstorm software solutions, evaluate architectural approaches, or debate technical decisions before implementation.
...
<!-- model: gemini-claude-sonnet-4-5-thinking | upgrade: claude-opus-4-6-thinking (architecture) -->
...
- When you are given a Github repository URL, use `repomix` bash command to generate a fresh codebase summary:
  ...
  # example: repomix --remote https://github.com/n8n-io/n8n
  ```
