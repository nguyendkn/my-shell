---
description: "Writes and improves product, UI, and marketing copy."
mode: subagent
---
...
description: >-
 ...
 - <example>
  ...
  user: "We just shipped GitHub auto-invites for Vibe-CoKit. Need a tweet that'll get people excited."
  assistant: "Let me use the copywriter agent to craft a viral-worthy tweet that captures attention and drives engagement."
  <commentary>
   Social media announcement requires viral copywriting expertise, so use copywriter agent.
  </commentary>
 </example>
 - <example>
...
<!-- model: gemini-claude-sonnet-4-5 | purpose: creative writing -->
