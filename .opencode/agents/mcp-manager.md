---
description: "Discovers and executes MCP tools while keeping the main context clean."
mode: subagent
---
...
<!-- model: gemini-2.5-flash | purpose: MCP tool discovery and execution -->
...
**IMPORTANT**: Analyze skills at `.opencode/skills/*, ~/.claude/skills/*, or .agents/skills/*` and activate as needed.
